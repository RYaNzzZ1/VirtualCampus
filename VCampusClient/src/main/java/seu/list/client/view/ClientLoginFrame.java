...
public class ClientLoginFrame extends JFrame implements ActionListener,MouseListener {
    ...
    public ClientLoginFrame(Socket socket){
        ...
        ImageIcon background = new ImageIcon("VCampusClient/src/main/resources/image/WindowsIcon/images/21.jpg");//背景
        ...
        jb_login.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/login3_1.png"));
        jb_login.setContentAreaFilled(false);
        jb_login.setBorder(null);//去边框

        jb_register= new JButton();
        jb_register.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/login4_1.png"));
        ...
        lNewLabel.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/SEULogo_2.png"));
        ...
        Maximized.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/login5_1.png"));
        ...
        Closed = new JButton("");
        Closed.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/login6_1.png"));
        ...
        Minimized.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/login7_1.png"));
        ...
        Jlb_photo.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/WindowsIcon/images/20.jpg"));


        JLabel backicon1 = new JLabel("");
        backicon1.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/white.png"));
        ...
        back.setIcon(new ImageIcon("VCampusClient/src/main/resources/image/WindowsIcon/images/21.jpg"));
